...
test_base_dir = "/home/reshma/Otolith/captioning/otolith/model_data/test"  # <-- your test data path
...
########################################################################
out_csv = "grayscale_otolith_test_results_progress.csv"
...
for species in sorted(os.listdir(test_base_dir)):
    ...
    for img_file in sorted(os.listdir(species_dir)):
        ...
        try:
            sample = {"image": Image.open(img_path).convert("L").convert("RGB")}
