...
CSV = "/home/reshma/Otolith/captioning/otolith/llama/grayscale_output_filtered.csv"
...
plt.savefig("llama/plots/confusion_matrix_grayscale_llama.png", bbox_inches="tight", dpi=600, facecolor="white")
plt.show()
